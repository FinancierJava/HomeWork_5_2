...
public class HomeWork5 {
    ...
    public static class Person {
        ...
        public Person(String name, Integer protection, Integer health) {
            this.name = name;
        ...
        public void takeDamage(Integer damage) throws PersonDead {
            if (damage < 0) {
            ...
            if (health <= 0) {
                throw new PersonDead(name + " погиб");
            }
        }
    ...
    public static class Mage extends Person {
        ...
        @Override
        public void takeDamage(Integer damage) throws PersonDead {
            int debuff = getHealth() % 10;
            super.takeDamage(damage - getProtection() - debuff);
        }
